...
TodoItem.create! [
  ...
  { id: 2, due_date: Date.today+1.year, title: "A", description: "a", completed: Date.today+1.year, todo_list_id: 1 },
  { id: 3, due_date: Date.today+1.year, title: "A", description: "a", completed: Date.today+1.year, todo_list_id: 1 },
  { id: 4, due_date: Date.today+1.year, title: "A", description: "a", completed: Date.today+1.year, todo_list_id: 1 },
  ...
  { id: 8, due_date: Date.today+1.year, title: "A", description: "a", completed: Date.today+1.year, todo_list_id: 2 },
  ...
  { id: 16, due_date: Date.today+1.year, title: "A", description: "a", completed: Date.today+1.year, todo_list_id: 4 },
